...
add_shortcode('gallery', 'wgallery_shortcode');


function wgallery_shortcode( $attr ) {
	$post = get_post();
	...
	$gallery_div = "<div id='$selector' class='galery_folder'>";
	...
	foreach ( $attachments as $id => $attachment ) {
		...
		$image_output = wp_get_attachment_image( $id, $atts['size'], false, $attr );
		$image_output = '<img src="'.wp_get_attachment_image_src($id,'gallery_single')[0].'">';
		$s=wp_get_attachment_image_src( $id, 'large' );
		//var_dump($s);
		$image_output = '<a class="fancybox_sm" rel="group" href="'. $s[0].'">'.$image_output.'</a>';
		$output .= "<div class='fancy_wr'>".$image_output."</div>";
